# Description: The main file of the application. It contains the routes and the logic of the application.
...
@app.route('/logout')
def logout():
    session.pop('member_id', None)  # Remove the user ID from the session
    return redirect(url_for('login'))
